...
export default function Dashboard() {
  ...
  return (
    ...
    {/*
      ...
      4  = gap-1    | micro
      8  = gap-2    | xs
      12 = gap-3    | sm (between cards in a list)
      16 = p-4      | md (card inner padding, mobile side padding)
      24 = gap-6    | lg (between sections)
      32 = gap-8    | xl (desktop section gaps)
    */}
    <motion.div 
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-4 sm:pt-6 sm:pb-6 space-y-6 sm:space-y-8" style={{ paddingLeft: 'max(16px, env(safe-area-inset-left))', paddingRight: 'max(16px, env(safe-area-inset-right))' }}>
        ...
        >
          ...
          <div className="relative z-10 px-4 py-6 sm:px-8 sm:py-8 lg:px-12 lg:py-12">
            ...
            <motion.div
              variants={VARIANTS.item}
              className="grid grid-cols-3 gap-3 sm:gap-4 lg:gap-6 mb-6 sm:mb-8 lg:mb-8"
            >
        ...
        <motion.div variants={VARIANTS.item}>
          <Link to={createPageUrl("AboutAllPlay")}>
            ...
            >
              <div className="flex flex-col sm:flex-row items-center sm:items-stretch gap-4 p-4 sm:p-6">
