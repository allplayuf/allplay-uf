    ...
    <div className="min-h-screen bg-[#0F1513] pb-24 lg:pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-3xl shadow-[0_30px_90px_rgba(0,0,0,0.5)] border border-[#F4743B]/30"
        >
          {/* Dark gradient base */}
          ...
          <motion.div
            className="absolute inset-0 bg-gradient-to-br from-[#F4743B]/25 via-[#E5683A]/15 to-transparent"
            animate={{
              opacity: [0.4, 0.6, 0.4]
            }}
          ...
          <motion.div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] lg:w-[700px] lg:h-[700px] rounded-full border-2 border-[#F4743B]/20"
            animate={{
              scale: [1, 1.15, 1],
              rotate: [0, 90, 0],
              opacity: [0.2, 0.4, 0.2]
          ...
          />
          <motion.div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[700px] lg:w-[900px] lg:h-[900px] rounded-full border border-[#E5683A]/10"
            animate={{
              scale: [1.1, 1, 1.1],
              rotate: [0, -90, 0],
          ...
          {/* Ambient Orbs */}
          <motion.div
            className="absolute top-10 lg:top-20 right-10 lg:right-20 w-32 h-32 lg:w-48 lg:h-48 bg-[#F4743B]/20 rounded-full blur-3xl"
            animate={{
              x: [0, 30, 0],
              y: [0, -30, 0],
              scale: [1, 1.2, 1],
          ...
          />
          <motion.div
            className="absolute bottom-10 lg:bottom-20 left-10 lg:left-20 w-40 h-40 lg:w-56 lg:h-56 bg-[#E5683A]/15 rounded-full blur-3xl"
            animate={{
              x: [0, -20, 0],
              y: [0, 20, 0],
              scale: [1, 1.15, 1],
          ...
          {[...Array(8)].map((_, i) => (
            <motion.div
              key={i}
              className="absolute w-1 h-1 lg:w-2 lg:h-2 bg-[#F4743B]/60 rounded-full"
              style={{
                left: `${15 + i * 12}%`,
                top: `${25 + (i % 4) * 20}%`,
              }}
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-12">
            ...
            <div className="flex items-center gap-4 sm:gap-6 mb-6 sm:mb-8 lg:mb-10">
              ...
              >
                {/* Epic Glow */}
                <motion.div 
                  className="absolute -inset-6 bg-gradient-to-r from-[#F4743B]/50 via-[#E5683A]/50 to-[#F4743B]/50 rounded-full blur-3xl"
                  animate={{
                    scale: [1, 1.2, 1],
                    opacity: [0.5, 0.8, 0.5]
                  }}
                ...
                <div className="relative w-20 h-20 sm:w-28 sm:h-28 lg:w-40 lg:h-40 rounded-3xl overflow-hidden border-4 border-[#F4743B]/60 shadow-[0_20px_60px_rgba(244,116,59,0.4)] bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm transform group-hover:rotate-3 transition-transform duration-500 flex items-center justify-center">
                ...
                <div className="hidden lg:block absolute -top-3 -right-3 w-8 h-8 border-t-4 border-r-4 border-[#F4743B] rounded-tr-2xl"></div>
                <div className="hidden lg:block absolute -bottom-3 -left-3 w-8 h-8 border-b-4 border-l-4 border-[#F4743B] rounded-bl-2xl"></div>
              </motion.div>
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  {user?.matches_played || 0} matcher • {user?.current_streak || 0} dagars streak
                </motion.p>
              </div>
            </div>
            ...
            >
              <Link to={createPageUrl("Matches")} className="w-full">
                <motion.button
                ...
                >
                  <PlayCircle className="w-4 h-4 lg:w-5 lg:h-5" strokeWidth={2.5} />
                  <span>Hitta match</span>
                </motion.button>
              </Link>
              <motion.button
                whileHover={{ y: -4, scale: 1.02 }}
