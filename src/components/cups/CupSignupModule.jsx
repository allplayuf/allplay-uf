                ...
                {isRegistrationOpen && !isFull && (
                  <>
                    ...
                    <Button
                      ...
                      className="w-full bg-gradient-to-r from-[#F59E0B] to-[#D97706] hover:from-[#D97706] hover:to-[#B45309] text-white gap-2 h-12 font-semibold shadow-lg"
                    >
        ...
        <Card className="bg-[#121715] border border-[#223029] rounded-[20px]">
          <CardContent className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-lg font-semibold text-[#F4F7F5]">
            ...
            {participants.length === 0 ? (
              ...
              <div className="space-y-2 max-h-[400px] overflow-y-auto">
                {participants.map((p, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-[#18221E] rounded-xl border border-[#223029]">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                      {cup.signup_type === 'team' && p.team ? (
                        ...
                        <>
                          <div className="w-8 h-8 bg-gradient-to-br from-[#2BA84A] to-[#248232] rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <Badge className={`text-xs flex-shrink-0 ${
                      p.status === 'confirmed' 
                        ...
                        : 'bg-[#DC2626]/20 text-[#FCA5A5] border-[#DC2626]/30'
                    }`}>
                      {p.status === 'confirmed' ? '✓' : 
                       p.status === 'pending' ? '⏳' : '❌'}
                    </Badge>
