      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-[400px] bg-gradient-to-b from-[#040F0F] to-[#2D3A3A] rounded-[32px] border border-[#223029] shadow-2xl overflow-hidden flex flex-col"
            style={{ 
          ...
          >
            ...
            {/* Content Scroll Area - Fixed height with inner scroll */}
            <div className="flex-1 overflow-y-auto pt-20 px-6 pb-4 scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            ...
            <div className="flex-shrink-0 p-6 bg-gradient-to-t from-[#040F0F] via-[#040F0F]/95 to-transparent z-20 space-y-3 border-t border-white/5">
              <Button
                onClick={handleNext}
