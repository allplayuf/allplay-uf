    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-[60] p-4">
      <div className="bg-[#121715] border border-[#223029] rounded-[20px] w-full max-w-md p-6">
        <div className="flex items-center gap-3 mb-4 text-[#F4743B]">
            ...
            <h2 className="text-xl font-bold">Rapportera problem</h2>
        </div>
        
        <div className="space-y-4">
            <div className="space-y-2">
                <label className="text-sm text-[#B6C2BC]">Anledning</label>
                <Select onValueChange={setReason}>
                    <SelectTrigger className="bg-[#18221E] border-[#223029] text-white">
                        <SelectValue placeholder="Välj anledning" />
                    </SelectTrigger>
                    <SelectContent>
                        <SelectItem value="no_show">Spelare dök inte upp</SelectItem>
                        <SelectItem value="harassment">Olämpligt beteende</SelectItem>
                        <SelectItem value="facility_issue">Problem med planen</SelectItem>
            ...
            <div className="space-y-2">
                <label className="text-sm text-[#B6C2BC]">Beskrivning</label>
                <Textarea 
                    value={description}
