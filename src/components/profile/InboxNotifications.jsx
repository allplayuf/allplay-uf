    ...
    return (
      <Card className="bg-gradient-to-br from-[#121715] to-[#0F2917]/20 border border-[#223029] shadow-[0_6px_18px_rgba(0,0,0,0.22)] rounded-[20px]">
        <CardContent className="p-6 text-center">
          <div className="w-12 h-12 bg-[#2BA84A]/10 rounded-xl flex items-center justify-center mx-auto mb-3 ring-1 ring-[#2BA84A]/20">
            <Inbox className="w-6 h-6 text-[#2BA84A]" />
          </div>
          <h3 className="text-lg font-bold text-[#F4F7F5] mb-1">
            Inga nya notiser
          </h3>
